...
let inputUserApiKey = document.getElementById("api-key") as HTMLInputElement;
...
inputPassword.addEventListener('change', function preencherSenha() {
  password = inputPassword.value;
  validateLoginButton();
});

inputUserName.addEventListener('change', function preencherLogin() {
  username = inputUserName.value
  validateLoginButton();
});

inputUserApiKey.addEventListener('change',  function preencherApi() {
  apiKey = inputUserApiKey.value;
  validateLoginButton();
})
